...
namespace FaultMenager_DataAccess.Migrations
{
    ...
    [Migration("20220523185938_AddedSumcontractorWorker")]
    partial class AddedSumcontractorWorker
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FaultMenager_Models.Models.SubcontractorFirm", b =>
                {
                    b.Property<int>("SubcontractorFirmId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SubcontractorFirmId"), 1L, 1);
                    ...
                    b.HasKey("SubcontractorFirmId");

                    b.ToTable("SubcontractorFirms");
                });

            modelBuilder.Entity("FaultMenager_Models.Models.SubcontractorWorker", b =>
                {
                    b.Property<int>("SubcontractorId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("SubcotractorFirmId")
                        .HasColumnType("int");

                    b.Property<int>("WorkerPhone")
                        .HasMaxLength(9)
                        .HasColumnType("int");

                    b.HasKey("SubcontractorId");

                    b.HasIndex("SubcotractorFirmId");

                    b.ToTable("SubcontractorWorker");
                });
            ...
            modelBuilder.Entity("FaultMenager_Models.Models.Fault", b =>
                {
                    ...
                    b.HasOne("FaultMenager_Models.Models.SubcontractorFirm", "SubcontractorFirm")
                        .WithMany("Faults")
                    ...
                    b.Navigation("SubcontractorFirm");
                });
            ...
            modelBuilder.Entity("FaultMenager_Models.Models.SubcontractorWorker", b =>
                {
                    b.HasOne("FaultMenager_Models.Models.SubcontractorFirm", "SubcontractorFirm")
                        .WithMany("Workers")
                        .HasForeignKey("SubcotractorFirmId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
